...
export const keyResultMetricMin: KeyResultMetricMin = {
  ...
  baseline: 10.0,
  stretchGoal: 25.0,
  wordingCommitValue: 14.5,
  wordingTargetValue: 20.5,
...
export const keyResultMetricMinScoring: KeyResultMetricMin = {
  ...
  baseline: 25.0,
  stretchGoal: 75.0,
  wordingCommitValue: 40,
  wordingTargetValue: 60,
  lastCheckIn: {
    id: 800,
    version: 1,
    value: 50,
...
export const keyResultMetricMinScoringInversion: KeyResultMetricMin = {
  ...
  baseline: 50.0,
  stretchGoal: 0.0,
  wordingCommitValue: 35,
  wordingTargetValue: 15,
  lastCheckIn: {
    id: 800,
    version: 1,
    value: 12.5,
...
export const keyResultMetric: KeyResultMetric = {
  ...
  baseline: 30,
  stretchGoal: 100,
  wordingCommitValue: 51,
  wordingTargetValue: 79,
  unit: UNIT_PERCENT,
  owner: users[3],
  keyResultType: 'metric',
  objective: {
...
export const keyResultActions: KeyResultMetric = {
  ...
  baseline: 10,
  stretchGoal: 30,
  wordingCommitValue: 16,
  wordingTargetValue: 24,
  unit: UNIT_PERCENT,
  owner: users[3],
  keyResultType: 'metric',
  objective: {
