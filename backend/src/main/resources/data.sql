...
insert into quarter(quarter_id, quarter_label) values
        (1, 'GJ 11/12-Q1');

insert into objective(id, title, owner_id, team_id, quarter_quarter_id, progress, created_on, description) values
...
insert into key_result(id, objective_id, owner_id, quarter_quarter_id, expected_evolution, unit, basis_value, target_value, created_by_id, created_on, title, description) values
