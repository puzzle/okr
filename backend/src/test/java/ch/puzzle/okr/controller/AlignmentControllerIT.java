...
class AlignmentControllerIT {
    ...
    static List<AlignmentSelection> alignmentSelectionPuzzle = List
            .of(AlignmentSelection.Builder
                ...
                AlignmentSelection.Builder
                        ...
                        .build());
    static List<AlignmentSelection> alignmentSelectionOKR = List
            .of(AlignmentSelection.Builder
                    .builder()
                ...
                AlignmentSelection.Builder
                        ...
                        .build());
    static AlignmentSelection alignmentSelectionEmptyKeyResults = AlignmentSelection.Builder
            .builder()
    ...
    void shouldGetAllObjectivesWithKeyResults() throws Exception {
        ...
        BDDMockito
                .given(alignmentSelectionBusinessService.getAlignmentSelectionByQuarterIdAndTeamIdNot(2L, 4L))
                .willReturn(alignmentSelections);

        mvc
                .perform(get("/api/v2/alignments/selections?quarter=2&team=4").contentType(MediaType.APPLICATION_JSON))
    ...
    void shouldGetAllObjectivesWithKeyResultsIfAllObjectivesFiltered() throws Exception {
        BDDMockito
                .given(alignmentSelectionBusinessService.getAlignmentSelectionByQuarterIdAndTeamIdNot(any(), any()))
                .willReturn(Collections.emptyList());

        mvc
                .perform(get("/api/v2/alignments/selections").contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk())
