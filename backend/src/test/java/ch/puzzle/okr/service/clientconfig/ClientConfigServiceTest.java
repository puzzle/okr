...
public class ClientConfigServiceTest {
    ...
    void getConfigBasedOnActiveEnvShouldThrowExceptionIfClientCustomizationIsNotFound(String tenant,
                                                                                      String hostname,
                                                                                      String subdomain) {
        // arrange
        TenantConfigProvider.TenantConfig tenantConfig = getTenantConfig(tenant);
    ...
    void getConfigBasedOnActiveEnvShouldThrowExceptionIfClientConfigIsNotFound(String tenant,
                                                                               String hostname,
                                                                               String subdomain) {
        // arrange
        TenantClientCustomization tenantCustomization = getTenantClientCustomization(tenant);
    ...
    private ClientConfigService getClientConfig(TenantConfigProvider.TenantConfig tenantConfig,
                                                TenantClientCustomization tenantClientCustomization,
                                                String tenantId) {
