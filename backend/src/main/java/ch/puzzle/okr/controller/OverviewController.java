...
public class OverviewController {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200",
            description = "Returned a List of teams and their objectives", content = {@Content(
                    mediaType = "application/json", schema = @Schema(
                            implementation = OverviewDto.class))}), @ApiResponse(responseCode = "400",
                                    ...
                                    content = @Content), @ApiResponse(responseCode = "401",
                                            ...
                                            content = @Content), @ApiResponse(responseCode = "404",
                                                    ...
                                                    content = @Content)})
    @GetMapping("")
    public ResponseEntity<List<OverviewDto>> getOverview(@RequestParam(required = false, defaultValue = "",
            name = "team") List<Long> teamFilter, @RequestParam(required = false, defaultValue = "",
                    name = "quarter") Long quarterFilter, @RequestParam(required = false, defaultValue = "",
