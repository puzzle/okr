...
-- Example: V1.2__Run_only_for_pitc_user.sql

-- Use a PL/pgSQL anonymous block for conditional execution
DO
$$
    BEGIN
...
--
    ...
    END
$$;
-- End of the PL/pgSQL block

-- Any SQL commands placed *outside* the DO block will execute regardless of the user check.
