...
public class ObjectiveController {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200",
            ...
            content = {@Content(mediaType = "application/json",
                    schema = @Schema(implementation = ObjectiveDto.class))}), @ApiResponse(responseCode = "401",
    ...
    public ResponseEntity<ObjectiveDto> duplicateObjective(@Parameter(
            description = "The ID for duplicating an Objective.",
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200",
            ...
            content = {@Content(mediaType = "application/json",
                    schema = @Schema(implementation = ObjectiveDto.class))}), @ApiResponse(responseCode = "226",
                            description = "Updated Objective in db but quarter was not changed",
                            content = {@Content(mediaType = "application/json",
                                    schema = @Schema(implementation = ObjectiveDto.class))}), @ApiResponse(
                                            responseCode = "400",
