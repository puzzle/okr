...
SELECT o.id as entity_id, o.title, o.team_id, o.quarter_id, a.alignment_type, a.aligned_objective_id, a.target_key_result_id, a.target_objective_id
FROM objective o
         JOIN alignment a ON o.id IN (a.aligned_objective_id, a.target_objective_id)

UNION

SELECT kr.id as entity_id, kr.title, o.team_id, o.quarter_id, a.alignment_type, a.aligned_objective_id, a.target_key_result_id, a.target_objective_id
FROM key_result kr
