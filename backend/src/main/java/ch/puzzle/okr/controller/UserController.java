...
public class UserController {
    ...
    public UserDto setOkrChampion(@Parameter(description = "The ID for requested user.",
                                             required = true) @PathVariable long id, @Parameter(description = "okrChampion property of user is set to this flag.",
    ...
    public List<UserDto> createUsers(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "The users to create",
                                                                                           required = true) @RequestBody List<NewUserDto> newUserDtoList) {
