...
public class KeyResultController {
    ...
    public KeyResultDto getKeyResultById(@PathVariable
    long id) {
    ...
    @PostMapping
    public ResponseEntity<KeyResultDto> createKeyResult(@RequestBody
    ...
    public void deleteKeyResultById(@PathVariable
    long id) {
