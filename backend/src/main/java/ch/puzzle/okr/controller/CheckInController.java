...
public class CheckInController {
    ...
    public ResponseEntity<CheckInDto> getCheckInById(@PathVariable
    long id) {
    ...
    public ResponseEntity<CheckInDto> updateCheckIn(@Parameter(
    ...
    public void deleteCheckInById(@Parameter(
