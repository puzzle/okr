...
public class OverviewServiceTest {
    ...
    @BeforeEach
    void setUp() {
        this.objective1 = Objective.Builder.builder().withId(1L).withTitle("Objective 1").withQuarter(Quarter.Builder.builder().withId(1L).build()).withTeam(Team.Builder.builder().withId(1L).build()).build();
        this.objective2 = Objective.Builder.builder().withId(2L).withTitle("Objective 2").withQuarter(Quarter.Builder.builder().withId(2L).build()).withTeam(Team.Builder.builder().withId(1L).build()).build();
        this.objective3 = Objective.Builder.builder().withId(3L).withTitle("Objective 3").withQuarter(Quarter.Builder.builder().withId(1L).build()).withTeam(Team.Builder.builder().withId(2L).build()).build();
        ...
        this.overview1 = new OverviewDto(new TeamDto(team1.getId(), team1.getName()), List.of(new ObjectiveDto(objective1.getId(), objective1.getTitle(), null,null,
                null,null,null,objective1.getQuarter().getId(),null,null,null), new ObjectiveDto(objective2.getId(), objective2.getTitle(), null,null,
                null,null,null,objective2.getQuarter().getId(),null,null,null)));
        this.overview2 = new OverviewDto(new TeamDto(team2.getId(), team2.getName()), List.of(new ObjectiveDto(objective3.getId(), objective3.getTitle(), null,null,
                null,null,null,objective3.getQuarter().getId(),null,null,null)));
    ...
    void shouldFilterQuarterWithQuarterFilter() {
        OverviewDto overview1WithoutObjective2 = new OverviewDto(new TeamDto(team1.getId(), team1.getName()), List.of(new ObjectiveDto(objective1.getId(), objective1.getTitle(), null,null,
                null,null,null,objective1.getQuarter().getId(),null,null,null)));
        when(teamRepository.findAllById(Collections.emptyList())).thenReturn(teamList);
