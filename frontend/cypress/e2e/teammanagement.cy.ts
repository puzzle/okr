          ...
          () => {
            it("Search user",
              () => {
                ...
                cy.contains("app-member-detail h2",
                  "Robin Papierer");
              });
            ...
            it("Search team",
              () => {
                ...
                cy.contains("app-member-list h2",
                  "we are cube.³");
              });
            ...
            it("invite two members",
              () => {
                ...
                const firstNames = InviteMembersDialog.do()
                  .enterUser("Claudia",
                    "Meier",
                    "claudia.meier@test.ch")
                  .addAnotherUser()
                  .enterUser("Stefan",
                    "Schmidt",
                    "stefan.schmidt@test.ch")
                  .addAnotherUser()
                  .getFirstNames();

                // test error messages
                fillOutNewUser("Robin",
                  "",
                  "papierer");
