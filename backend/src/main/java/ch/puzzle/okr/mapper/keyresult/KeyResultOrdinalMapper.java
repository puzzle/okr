...
public class KeyResultOrdinalMapper {
    ...
    public KeyResultDto toDto(KeyResultOrdinal keyResult, List<Action> actionList) {
        ...
        return new KeyResultOrdinalDto(keyResult.getId(), keyResult.getVersion(), keyResult.getKeyResultType(), keyResult.getTitle(), keyResult.getDescription(), keyResult.getCommitZone(), keyResult.getTargetZone(), keyResult.getStretchZone(), ownerDto, objectiveDto, lastCheckInDto, keyResult.getCreatedOn(), keyResult.getModifiedOn(), keyResult.isWriteable(), actionList.stream()
    ...
    public KeyResultLastCheckInOrdinalDto getLastCheckInDto(Long keyResultId) {
        ...
        return new KeyResultLastCheckInOrdinalDto(lastCheckIn.getId(), lastCheckIn.getVersion(), ((CheckInOrdinal) lastCheckIn).getZone(), lastCheckIn.getConfidence(), lastCheckIn.getCreatedOn(), lastCheckIn.getChangeInfo(), lastCheckIn.getInitiatives());
    }
}
