...
public class UserAuthorizationService {
    ...
    public User setIsOkrChampion(long id, boolean isOkrChampion) {
        var user = userBusinessService.getUserById(id);
        AuthorizationService.checkRoleWriteAndReadAll(authorizationService.updateOrAddAuthorizationUser(), OkrResponseStatusException.of(ErrorKey.NOT_AUTHORIZED_TO_WRITE, USER));
    ...
    public void deleteEntityById(long id) {
        AuthorizationService.checkRoleWriteAndReadAll(authorizationService.updateOrAddAuthorizationUser(), OkrResponseStatusException.of(ErrorKey.NOT_AUTHORIZED_TO_DELETE, USER));
