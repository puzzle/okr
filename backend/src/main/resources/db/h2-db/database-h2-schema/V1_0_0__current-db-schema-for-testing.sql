...
SELECT TQ.TEAM_ID          AS "TEAM_ID",
       ...
       TQ.START_DATE       AS "QUARTER_START_DATE",
       TQ.END_DATE         AS "QUARTER_END_DATE",
...
FROM (SELECT T.ID AS TEAM_ID, T.VERSION AS TEAM_VERSION, T.NAME, Q.ID AS QUARTER_ID, Q.LABEL, Q.START_DATE, Q.END_DATE
      FROM TEAM T,
           QUARTER Q) TQ
