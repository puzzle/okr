...
public class ObjectiveControllerV2 {
    ...
    public ResponseEntity<ObjectiveDto> createObjective(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "The Objective as json to create a new Objective.", required = true)
    ...
    public ResponseEntity<ObjectiveDto> updateObjective(
            ...
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "The objective as json to update an existing Objective.", required = true)
            @RequestBody ObjectiveDto objectiveDTO) {
