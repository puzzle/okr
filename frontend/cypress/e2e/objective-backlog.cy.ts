  ...
  () => {
    ...
    it("Edit ongoing Objective can not choose backlog in quarter select",
      () => {
        ...
        overviewPage
          .getObjectiveByNameAndState("We can not move this to backlog",
            "ongoing")
          .findByTestId("three-dot-menu")
          .click();
        overviewPage.selectFromThreeDotMenu("Objective bearbeiten");
    ...
    it("Can release Objective to another quarter from backlog",
      () => {
        ...
        overviewPage.getObjectiveByNameAndState("We can not release this",
          "draft")
          .findByTestId("three-dot-menu")
          .click();
    ...
    it("Can edit Objective title in backlog",
      () => {
        ...
        overviewPage
          .getObjectiveByNameAndState("This is possible for edit",
            "draft")
          .findByTestId("three-dot-menu")
          .click();
        overviewPage.selectFromThreeDotMenu("Objective bearbeiten");
        ...
        overviewPage.getObjectiveByNameAndState("My new title",
          "draft");
      });
    ...
    it("Can edit Objective in backlog and change quarter",
      () => {
        ...
        overviewPage
          .getObjectiveByNameAndState("This goes to other quarter later",
            "draft")
          .findByTestId("three-dot-menu")
          .click();
        overviewPage.selectFromThreeDotMenu("Objective bearbeiten");
        ...
        overviewPage.visitGJForTests();
        overviewPage.getObjectiveByNameAndState("This goes to other quarter later",
          "draft");
      });
    ...
    it("Can duplicate in backlog",
      () => {
        ...
        overviewPage.getObjectiveByNameAndState("Ready for duplicate in backlog",
          "draft");
        overviewPage.getObjectiveByNameAndState("This is a new duplication in backlog",
          "draft");
      });
    ...
    it("should duplicate from backlog",
      () => {
        ...
        overviewPage.addObjective()
          ...
          .submitDraftObjective();
        overviewPage
          .getObjectiveByNameAndState("Ready for duplicate to another quarter",
            "draft")
          .findByTestId("three-dot-menu")
          .click();
        overviewPage.selectFromThreeDotMenu("Objective duplizieren");
        ...
        overviewPage.getObjectiveByNameAndState("Ready for duplicate to another quarter",
          "draft")
          .should("exist");
        cy.contains("New duplication from backlog")
          .should("not.exist");
        overviewPage.visitGJForTests();
        overviewPage.getObjectiveByNameAndState("New duplication from backlog",
          "draft")
          .should("exist");
      });
    ...
    it("Can duplicate ongoing Objective to backlog",
      () => {
        ...
        overviewPage
          .getObjectiveByNameAndState("Possible to duplicate into backlog",
            "ongoing")
          .findByTestId("three-dot-menu")
          .click();
        overviewPage.selectFromThreeDotMenu("Objective duplizieren");
