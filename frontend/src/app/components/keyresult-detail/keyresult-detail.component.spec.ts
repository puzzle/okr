...
describe("KeyresultDetailComponent",
  () => {
    ...
    beforeEach(async () => {
      ...
      jest.spyOn(keyResultServiceMock,
        "getFullKeyResult")
    ...
    it("should display edit keyresult button if writeable is true",
      async () => {
    ...
    it("should not display edit keyresult button if writeable is false",
      async () => {
        jest.spyOn(keyResultServiceMock,
          "getFullKeyResult")
    ...
    it("should display add check-in button if writeable is true",
      async () => {
    ...
    it("should not display add check-in button if writeable is false",
      async () => {
        jest.spyOn(keyResultServiceMock,
          "getFullKeyResult")
          .mockReturnValue(of(keyResultWriteableFalse));
    ...
    it("should trigger observable when subject gets next value",
      () => {
        const spy = jest.spyOn(component,
          "loadKeyResult");
    ...
    it("should close subscription on destroy",
      () => {
        const spyNext = jest.spyOn(component.ngDestroy$,
          "next");
        const spyComplete = jest.spyOn(component.ngDestroy$,
          "complete");
