...
class UserValidationServiceTest {
    ...
    private static Stream<Arguments> firstNameValidationArguments() {
        return Stream.of(arguments(StringUtils.repeat('1', 51), List.of(new ErrorDto("ATTRIBUTE_SIZE_BETWEEN", List.of(
                                                                                                                       "firstname",
                                                                                                                       "User",
                                                                                                                       "2",
                                                                                                                       "50")))),
                         ...
                         arguments("", List.of(new ErrorDto("ATTRIBUTE_NOT_BLANK", List.of("firstname", "User")),
                                               new ErrorDto("ATTRIBUTE_SIZE_BETWEEN", List.of("firstname", "User", "2",
                                                                                              "50")))), arguments(" ",
                                                                                                                  List.of(new ErrorDto("ATTRIBUTE_NOT_BLANK",
                                                                                                                                       List.of("firstname",
                                                                                                                                               "User")),
                                                                                                                          new ErrorDto("ATTRIBUTE_SIZE_BETWEEN",
                                                                                                                                       List.of("firstname",
                                                                                                                                               ...
                                                                                                                                               "2",
                                                                                                                                               "50")))),
                         arguments("         ", List.of(new ErrorDto("ATTRIBUTE_NOT_BLANK", List.of("firstname",
                                                                                                    "User")))),
    ...
    private static Stream<Arguments> lastNameValidationArguments() {
        return Stream.of(arguments(StringUtils.repeat('1', 51), List.of(new ErrorDto("ATTRIBUTE_SIZE_BETWEEN", List.of(
                         ...
                         arguments("", List.of(new ErrorDto("ATTRIBUTE_NOT_BLANK", List.of("lastname", "User")),
                                               new ErrorDto("ATTRIBUTE_SIZE_BETWEEN", List.of("lastname", "User", "2",
                                                                                              "50")))), arguments(" ",
                                                                                                                  List.of(new ErrorDto("ATTRIBUTE_NOT_BLANK",
                                                                                                                                       List.of("lastname",
                                                                                                                                               "User")),
                                                                                                                          new ErrorDto("ATTRIBUTE_SIZE_BETWEEN",
                                                                                                                                       List.of("lastname",
                                                                                                                                               ...
                                                                                                                                               "2",
                                                                                                                                               "50")))),
                         arguments("         ", List.of(new ErrorDto("ATTRIBUTE_NOT_BLANK", List.of("lastname",
                                                                                                    "User")))),
    ...
    private static Stream<Arguments> emailValidationArguments() {
        return Stream.of(arguments(("1".repeat(251)), List.of(new ErrorDto("ATTRIBUTE_SIZE_BETWEEN", List.of("email",
                                                                                                             "User",
                                                                                                             "2",
                                                                                                             "250")),
                                                              new ErrorDto("ATTRIBUTE_NOT_VALID", List.of("email",
                                                                                                          "User")))),
                         arguments(("1"), List.of(new ErrorDto("ATTRIBUTE_SIZE_BETWEEN", List.of("email", "User", "2",
                                                                                                 "250")), new ErrorDto(
                                                                                                                       "ATTRIBUTE_NOT_VALID",
                                                                                                                       List.of("email",
                                                                                                                               "User")))),
                         arguments((""), List.of(new ErrorDto("ATTRIBUTE_NOT_BLANK", List.of("email", "User")),
                                                 new ErrorDto("ATTRIBUTE_SIZE_BETWEEN", List.of("email", "User", "2",
                                                                                                "250")))), arguments(
                                                                                                                     (" "),
                                                                                                                     List.of(new ErrorDto("ATTRIBUTE_NOT_BLANK",
                                                                                                                                          List.of("email",
                                                                                                                                                  "User")),
                                                                                                                             new ErrorDto("ATTRIBUTE_NOT_VALID",
                                                                                                                                          List.of("email",
                                                                                                                                                  "User")),
                                                                                                                             new ErrorDto("ATTRIBUTE_SIZE_BETWEEN",
                                                                                                                                          List.of("email",
    ...
    void validateAuthorisationTokenShouldThrowErrorWhenNull() {
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator
                                                                                                             .validateAuthorisationToken(null));
