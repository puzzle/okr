...
class ObjectiveControllerIT {
    ...
    static KeyResultDto keyresult1Dto = new KeyResultDto(5L, 1L, "Keyresult 1", "Description", 1L, "Alice", "Wunderland", quarterId, 1, 2022, ExpectedEvolution.CONSTANT, Unit.PERCENT, 20L, 100L);
    static KeyResultDto keyresult2Dto = new KeyResultDto(7L, 1L, "Keyresult 2", "Description", 1L, "Alice", "Wunderland", quarterId, 1, 2022, ExpectedEvolution.CONSTANT, Unit.PERCENT, 20L, 100L);
