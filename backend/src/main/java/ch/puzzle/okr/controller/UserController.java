...
public class UserController {
    ...
    public UserController(UserAuthorizationService userAuthorizationService,
    ...
    @PutMapping(
            path = "/{id}/isokrchampion/{isOkrChampion}"
    )
    public UserDto setOkrChampion(@Parameter(
            description = "The ID for requested user.",
            required = true
    ) @PathVariable
    long id,
    ...
    @GetMapping(
            path = "/{id}/ismemberofteams"
    )
    public Boolean isUserMemberOfTeams(@Parameter(
    ...
    public UserOkrDataDto getUserOkrData(@PathVariable
    long id) {
