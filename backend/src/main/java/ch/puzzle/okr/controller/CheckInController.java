...
public class CheckInController {
    ...
    public ResponseEntity<CheckInDto> updateCheckIn(@Parameter(description = "The ID for updating a Check-in.",
                                                               required = true) @PathVariable Long id, @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "The Check-in as json to update an existing Check-in.",
                                        ...
                                        content = {@Content(mediaType = "application/json", schema = @Schema(
                                                                                                             implementation = CheckInDto.class))}), @ApiResponse(responseCode = "400",
                                                                                                                                                                 ...
                                                                                                                                                                 content = @Content), @ApiResponse(responseCode = "401",
                                                                                                                                                                                                   ...
                                                                                                                                                                                                   content = @Content)})
    @PostMapping
    public ResponseEntity<CheckInDto> createCheckIn(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "The Check-in as json to create a new Check-in.",
                                                                                                          required = true) @RequestBody CheckInDto checkInDto) {
        CheckIn checkIn = checkInMapper.toCheckIn(checkInDto);
