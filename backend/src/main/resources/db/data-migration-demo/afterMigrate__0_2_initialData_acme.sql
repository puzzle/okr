...
$$
    BEGIN
        IF session_user like '%acme' THEN
            ...
            INSERT INTO okr_acme.person
            VALUES (3, 'brantschen@puzzle.ch', 'Jean-Claude', 'Brantschen', 1, true);
            INSERT INTO okr_acme.person
            VALUES (4, 'endtner@puzzle.ch', 'Janik', 'Endtner', 1, true);
            INSERT INTO okr_acme.person
            VALUES (11, 'wunderland@puzzle.ch', 'Alice', 'Wunderland', 1, false);
            INSERT INTO okr_acme.person
            VALUES (21, 'baumeister@puzzle.ch', 'Bob', 'Baumeister', 1, false);
            INSERT INTO okr_acme.person
            VALUES (31, 'peterson@puzzle.ch', 'Findus', 'Peterson', 1, false);
            INSERT INTO okr_acme.person
            VALUES (51, 'papierer@puzzle.ch', 'Robin', 'Papierer', 1, false);
            INSERT INTO okr_acme.person
            VALUES (61, 'gl@gl.com', 'gl', 'gl', 1, true);
            INSERT INTO okr_acme.person
            VALUES (1003, 'gl@acme.com', 'Jaya', 'Norris', 1, true);
            INSERT INTO okr_acme.person
            VALUES (1005, 'ya.minder05@gmail.com', 'Yanick', 'Minder', 1, true);
            INSERT INTO okr_acme.person
            VALUES (1006, 'kathrin.beer@bls.ch', 'Kathrin', 'Beer', 0, false);
            INSERT INTO okr_acme.person
            VALUES (1007, 'tanja.bieri@bls.ch', 'Tanja', 'Bieri', 0, false);
            INSERT INTO okr_acme.person
            VALUES (1008, 'matthias.blum@five-e.ch', 'Matthias', 'Blum', 0, false);
            INSERT INTO okr_acme.person
            VALUES (1009, 'patrik.landolfo@five-e.ch', 'Pat', 'Landolfo', 0, false);
            INSERT INTO okr_acme.person
            VALUES (1010, 'nicole@zeilenwerk.ch', 'Nicole', 'Pauli', 0, false);
            INSERT INTO okr_acme.person
            VALUES (1011, 'dario@zeilenwerk.ch', 'Dario', 'Schwab', 0, false);
            INSERT INTO okr_acme.person
...
--
            ...
            INSERT INTO okr_acme.quarter
            VALUES (999, 'Backlog', NULL, NULL);
            INSERT INTO okr_acme.quarter
            VALUES (8, 'GJ 25/26-Q1', '2025-07-01', '2025-09-30');
            INSERT INTO okr_acme.quarter
            VALUES (7, 'GJ 24/25-Q4', '2025-04-01', '2025-06-30');
            INSERT INTO okr_acme.quarter
            VALUES (6, 'GJ 24/25-Q3', '2025-01-01', '2025-03-31');
            INSERT INTO okr_acme.quarter
            VALUES (5, 'GJ 24/25-Q2', '2024-10-01', '2024-12-31');
            INSERT INTO okr_acme.quarter
            VALUES (4, 'GJ 24/25-Q1', '2024-07-01', '2024-09-30');
            INSERT INTO okr_acme.quarter
            VALUES (3, 'GJ 23/24-Q4', '2024-04-01', '2024-06-30');
            INSERT INTO okr_acme.quarter
            VALUES (2, 'GJ 23/24-Q3', '2024-01-01', '2024-03-31');
            INSERT INTO okr_acme.quarter
            VALUES (1, 'GJ 23/24-Q2', '2023-10-01', '2023-12-31');
...
--
            ...
            INSERT INTO okr_acme.team
            VALUES (4, '/BBT', 1);
            INSERT INTO okr_acme.team
            VALUES (5, 'Puzzle ITC', 1);
            INSERT INTO okr_acme.team
            VALUES (6, 'LoremIpsum', 1);
            INSERT INTO okr_acme.team
            VALUES (7, 'Mobility', 1);
            INSERT INTO okr_acme.team
            VALUES (8, 'we are cube.³', 1);
            INSERT INTO okr_acme.team
            VALUES (1009, 'BLS AG', 0);
            INSERT INTO okr_acme.team
            VALUES (1010, 'five-e business AG', 0);
            INSERT INTO okr_acme.team
            VALUES (1011, 'Zeilenwerk GmbH', 0);
...
--
            ...
            VALUES (1, 5, 'Not successful because there were many events this month', 1);
            INSERT INTO okr_acme.completed
            VALUES (2, 9, 'Was not successful because we were too slow', 1);
            INSERT INTO okr_acme.completed
            VALUES (3, 8, 'Sadly we had not enough members to complete this objective', 1);
            INSERT INTO okr_acme.completed
            VALUES (4, 10, 'Objective could be completed fast and easy', 1);
...
--
            ...
            INSERT INTO okr_acme.person_team
            VALUES (true, 1, 1, 1, 4);
            INSERT INTO okr_acme.person_team
            VALUES (false, 1, 2, 1, 5);
            INSERT INTO okr_acme.person_team
            VALUES (false, 1, 3, 1, 7);
            INSERT INTO okr_acme.person_team
            VALUES (false, 1, 4, 11, 6);
            INSERT INTO okr_acme.person_team
            VALUES (false, 1, 5, 21, 8);
            INSERT INTO okr_acme.person_team
            VALUES (true, 1, 6, 31, 8);
            INSERT INTO okr_acme.person_team
            VALUES (true, 1, 8, 51, 6);
            INSERT INTO okr_acme.person_team
            VALUES (true, 1, 9, 61, 5);
            INSERT INTO okr_acme.person_team
            VALUES (false, 1, 10, 61, 6);
            INSERT INTO okr_acme.person_team
            VALUES (false, 1, 13, 3, 5);
            INSERT INTO okr_acme.person_team
            VALUES (false, 1, 14, 3, 7);
            INSERT INTO okr_acme.person_team
            VALUES (false, 1, 15, 4, 5);
            INSERT INTO okr_acme.person_team
            VALUES (false, 1, 16, 4, 7);
            INSERT INTO okr_acme.person_team
            VALUES (true, 1, 21, 1008, 1010);
            INSERT INTO okr_acme.person_team
            VALUES (true, 1, 22, 1009, 1010);
            INSERT INTO okr_acme.person_team
            VALUES (true, 1, 24, 1010, 1011);
            INSERT INTO okr_acme.person_team
            VALUES (true, 1, 25, 1011, 1011);
            INSERT INTO okr_acme.person_team
            VALUES (true, 1, 18, 1006, 1009);
            INSERT INTO okr_acme.person_team
            VALUES (true, 1, 19, 1007, 1009);
            INSERT INTO okr_acme.person_team
            VALUES (true, 1, 26, 1004, 7);
