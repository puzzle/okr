...
public class ObjectiveController {
    ...
    public ResponseEntity<ObjectiveDto> getObjective(@Parameter(
    ...
    public void deleteObjectiveById(@Parameter(
    ...
    public ResponseEntity<ObjectiveDto> updateObjective(@Parameter(
