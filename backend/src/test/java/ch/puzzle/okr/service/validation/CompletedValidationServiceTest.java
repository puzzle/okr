...
class CompletedValidationServiceTest {
    ...
    void setUp() {
        ...
        doThrow(new ResponseStatusException(HttpStatus.NOT_FOUND, String.format("%s with id %s not found", completedPersistenceService.getModelName(), 2L))).when(completedPersistenceService)
    ...
    private static Stream<Arguments> nameValidationArguments() {
        return Stream.of(arguments(StringUtils.repeat('1', 5000), List.of(new ErrorDto("ATTRIBUTE_SIZE_BETWEEN", List.of("comment", "Completed", "0", "4096")))));
    }
    ...
    void validateOnCreateShouldThrowExceptionWhenIdIsNotNull() {
        ...
        // act + assert
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnCreate(completed));
    ...
    void validateOnCreateShouldThrowExceptionWhenAttrsAreMissing() {
        ...
        // act + assert
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnCreate(completedInvalid));
