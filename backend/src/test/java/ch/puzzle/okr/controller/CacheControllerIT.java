...
class CacheControllerIT {
    ...
    void shouldEmptyAuthorisationUsersCache() throws Exception {
        mvc.perform(post("/api/v2/caches/emptyAuthorizationUsersCache").with(SecurityMockMvcRequestPostProcessors
                .csrf())).andExpect(MockMvcResultMatchers.status().is2xxSuccessful());
