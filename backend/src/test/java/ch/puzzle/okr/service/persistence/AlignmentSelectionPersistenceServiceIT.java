...
class AlignmentSelectionPersistenceServiceIT {
    ...
    private static Stream<AlignmentSelectionId> getExpectedAlignmentSelectionIds() {
        return Stream.of(AlignmentSelectionId.of(9L, 15L), AlignmentSelectionId.of(9L, 16L), AlignmentSelectionId.of(9L,
                                                                                                                     17L),
                         AlignmentSelectionId.of(4L, 6L), AlignmentSelectionId.of(4L, 7L), AlignmentSelectionId.of(4L,
                                                                                                                   8L),
                         AlignmentSelectionId.of(3L, 3L), AlignmentSelectionId.of(3L, 4L), AlignmentSelectionId.of(3L,
                                                                                                                   5L),
                         AlignmentSelectionId.of(8L, 18L), AlignmentSelectionId.of(8L, 19L), AlignmentSelectionId.of(
                                                                                                                     10L,
                                                                                                                     -1L));
    }
}
