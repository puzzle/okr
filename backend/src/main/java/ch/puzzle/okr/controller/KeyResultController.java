...
public class KeyResultController {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200",
            ...
            content = {@Content(mediaType = "application/json",
                    schema = @Schema(allOf = {KeyResultMetricDto.class, KeyResultOrdinalDto.class}))}), @ApiResponse(
                            responseCode = "401",
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "201",
            ...
            content = {@Content(mediaType = "application/json",
                    schema = @Schema(allOf = {KeyResultDto.class, KeyResultOrdinalDto.class}))}), @ApiResponse(
                            responseCode = "401",
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200",
            ...
            content = {@Content(mediaType = "application/json",
                    schema = @Schema(allOf = {KeyResultDto.class, KeyResultOrdinalDto.class}))}), @ApiResponse(
                            ...
                            content = {@Content(mediaType = "application/json",
                                    schema = @Schema(allOf = KeyResultDto.class))}), @ApiResponse(responseCode = "401",
