...
public class TeamController {
    ...
    public ResponseEntity<TeamDto> updateTeam(@Parameter(
    ...
    public void deleteTeamById(@Parameter(
    ...
    public void addUsersToTeam(@Parameter(
    ...
    @PutMapping(
        "/{id}/user/{userId}/removeuser"
    )
    public void removeUserFromTeam(@Parameter(
    ...
    @Operation(
            ...
            description = "If user is already member of this team, isAdmin is set. otherwise new team membership " + "is added with isAdmin true or false"
    )
    @ApiResponses(
            value = {@ApiResponse(
                    responseCode = "200",
    ...
    @PutMapping(
        "/{id}/user/{userId}/updateaddteammembership/{isAdmin}"
    )
    public void updateOrAddTeamMembership(@Parameter(
