...
class OverviewControllerIT {
    ...
    static List<Overview> overviewPuzzle = List
            .of(Overview.Builder
                    .builder()
                ...
                Overview.Builder
                        ...
                        .withCheckInCreatedOn(LocalDateTime.now())
                        .build());
    static List<Overview> overviewOKR = List
            .of(Overview.Builder
                    .builder()
    ...
    static Overview overviewKuchen = Overview.Builder
            .builder()
    ...
    static Overview simpleOverview = Overview.Builder
            .builder()
    ...
    void shouldGetAllTeamsWithObjective() throws Exception {
        ...
        BDDMockito
                .given(overviewAuthorizationService.getFilteredOverview(anyLong(), anyList(), anyString()))
                .willReturn(overviews);
        BDDMockito.given(overviewAuthorizationService.hasWriteAllAccess()).willReturn(true);

        mvc
                .perform(get("/api/v2/overview?quarter=2&team=1,2,3,4").contentType(MediaType.APPLICATION_JSON))
    ...
    void shouldGetAllTeamsWithObjectiveIfNoTeamsExists() throws Exception {
        ...
        mvc
                .perform(get("/api/v2/overview").contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    void shouldReturnOnlyFilteredObjectivesByQuarterAndTeam() throws Exception {
        ...
        mvc
                .perform(get("/api/v2/overview?quarter=2&team=1,3").contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    void shouldReturnTeamWithEmptyObjectiveListWhenNoObjectiveInFilteredQuarter() throws Exception {
        ...
        mvc
                .perform(get("/api/v2/overview?quarter=2&team=4").contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk())
