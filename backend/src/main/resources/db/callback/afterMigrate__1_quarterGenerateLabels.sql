...
$$
    ...
    BEGIN
        ...
        SELECT create_future_quarter_label(current_quarter, future_quarter_year, 8) INTO quarter_label;
        --RAISE NOTICE '%', quarter_label;

        -- current quarter
        SELECT create_current_quarter_label(current_quarter, current_year, 7) INTO quarter_label;
        --RAISE NOTICE '% *', quarter_label;
        ...
        FOR quarter_id IN REVERSE 6..1 LOOP
