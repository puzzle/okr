...
public class TenantJWSKeySelectorTest {
    ...
    void selectKeysThrowsExceptionIfTenantConfigIsNotFound() {
        ...
        IllegalArgumentException illegalArgumentException = assertThrows(IllegalArgumentException.class, () -> selector.selectKeys(jwsHeaderMock, jwtClaimsSetMock, securityContext));
