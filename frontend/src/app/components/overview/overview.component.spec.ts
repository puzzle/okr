...
describe("OverviewComponent",
  ...
  // @ts-ignore
    ...
    it("should load default overview on init",
      async () => {
        jest.spyOn(overviewService,
          "getOverview");
        markFiltersAsReady();
    ...
    it.each([
      ...
      async (
        ...
        expect(overviewService.getOverview)
          .toHaveBeenCalledWith(quarterParam,
            teamsParam,
            objectiveQueryParam);
    ...
    it("should refresh overview Entities after getOverview is called",
      async () => {
        jest.spyOn(component.overviewEntities$,
          "next");
        jest.spyOn(component,
          "loadOverview");
    ...
    it("should get default if call throws error",
      async () => {
