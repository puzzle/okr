...
public class TestDataDtoHelper {
    ...
    private static final KeyResultLastCheckInOrdinalDto lastCheckInOrdinalDto = new KeyResultLastCheckInOrdinalDto(CHECK_IN_ID,
                                                                                                                   CHECK_IN_VERSION,
    ...
    private static final KeyResultMetricDto keyResultMetricDto = new KeyResultMetricDto(KEY_RESULT_ID,
                                                                                        ...
                                                                                        null // actionList; ony used for keyResultMetric + action -> dto
