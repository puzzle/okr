...
describe('OverviewComponent', () => {
  ...
  it.each([
    ...
    async (query: string, quarterParam?: number, teamsParam?: number[], objectiveParam?: string) => {
      jest.spyOn(overviewService, 'getOverview');
      ...
      expect(overviewService.getOverview).toHaveBeenCalledWith(quarterParam, teamsParam, objectiveParam);
      expect(component.loadOverview).toHaveBeenCalledWith(quarterParam, teamsParam, objectiveParam);
    },
  );
