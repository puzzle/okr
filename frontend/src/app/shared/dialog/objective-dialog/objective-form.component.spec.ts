...
const teamService = {
  getAllTeams(): Observable<Team[]> {
    return of([
      { id: 1, version: 2, name: teamMin1.name, activeObjectives: 10, writeable: true, organisations: [] },
      { id: 4, version: 5, name: 'team2', activeObjectives: 4, writeable: true, organisations: [] },
    ]);
  },
};
