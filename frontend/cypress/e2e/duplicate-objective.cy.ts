  ...
  () => {
    ...
    it("Should be able to duplicate a objective into this quarter, including all keyResults",
      () => {
        ...
        overviewPage.getKeyResultOfObjective(duplicatedTitle,
          firstKeyResultName)
          .should("exist");
        overviewPage.getKeyResultOfObjective(duplicatedTitle,
          secondKeyResultName)
  ...
  () => {
    ...
    it("Duplicate ordinal checkin and validate value of scoring component",
      () => {
        ...
        overviewPage.checkForToaster("Das Objective wurde erfolgreich erstellt.",
          "success");
