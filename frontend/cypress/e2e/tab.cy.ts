...
describe("Tab workflow tests",
  () => {
    ...
    it("should be able to tab to header items",
      () => {
        tabAndCheck("team-management",
          "Teamverwaltung");
        tabAndCheck("help-button",
          "Hilfe");
        tabAndCheck("user-options",
          "Jaya Norris");
        cy.realPress("Enter");
        cy.pressUntilContains("Logout",
          "ArrowDown");
        focusedShouldHaveTestId("logout");
        cy.realPress("Escape");
        tabAndCheck("quarterFilter",
          "GJ");
      ...
      () => {
        ...
        it("should be able to complete and reopen objective",
          () => {
            ...
            cy.contains("h2",
              "Objective wiedereröffnen");
            focusedShouldHaveTestId("close-dialog");
            cy.contains("Soll dieses Objective wiedereröffnet werden?");
            tabAndCheck("confirm-no",
              "Nein");
            tabAndCheck("confirm-yes",
              "Ja");
            cy.realPress("Enter");
            focusedShouldHaveTestId("three-dot-menu");
          });
        ...
        it("should be able to open objective detail view",
          () => {
            ...
            tabAndCheck("add-keyResult-objective-detail",
              "Key Result hinzufügen");
            tabAndCheck("edit-objective",
      ...
      () => {
        it("Should be able to tab Keyresult dialog",
          () => {
            ...
            tabAndCheck("add-action-plan-line",
              "Weitere Action hinzufügen");
            tabAndCheck("ordinalTab",
              "Ordinal");
            cy.realPress("Enter");
        ...
        it("Should tab keyresult detail view",
          () => {
            ...
            tabAndCheck("show-all-checkins",
              "Alle Check-ins anzeigen");
            cy.realPress("Enter");
            cy.contains("Check-in History");
            focusedShouldHaveTestId("close-dialog");
            tabAndCheck("edit-check-in");
            tabAndCheck("closeButton",
              "Schliessen");
            cy.realPress("Enter");
            tabAndCheck("add-check-in",
              "Check-in erfassen");
            tabAndCheck("edit-keyResult",
      ...
      () => {
        it("Should tab team management",
          () => {
            tabAndCheck("team-management",
              "Teamverwaltung");
            cy.realPress("Enter");
            tabAndCheck("routerLink-to-overview",
              "Zurück zur OKR Übersicht");
            tabAndCheck("teamManagementSearch");
            tabAndCheck("add-team",
              "Team erfassen");
            tabAndCheck("all-teams-selector",
              "Alle Teams (4)");
          ...
          () => {
            ...
            cy.focused()
              ...
              .should("have.attr",
                "icon",
                "delete-icon.svg");
            tabAndCheck("new-member-add-row",
              "Weiterer Member hinzufügen");
            tabAndCheck("invite",
              "Einladen");
            tabAndCheck("new-member-cancel",
              "Abbrechen");
          });
        it("Should tab edit member",
          () => {
            cy.getByTestId("team-management")
              .click();
            cy.pressUntilContains("Alice Wunderland",
              "Tab");
            cy.tabForward();
            cy.realPress("Enter");
            cy.tabForward();
            ...
            cy.realPress("Enter");
            cy.tabForward();
            tabAndCheck("select-team-dropdown",
              "Puzzle ITC");
            tabAndCheck("select-team-role",
              "Team-Member");
            tabAndCheck("add-user-to-team-save",
              "Hinzufügen");
            tabAndCheck("add-user-to-team-cancel",
              "Abbrechen");
          });
      });
  });
