...
class TeamValidationServiceTest {
    ...
    void setUp() {
        ...
        doThrow(new ResponseStatusException(HttpStatus.NOT_FOUND, String.format("%s with id %s not found", teamPersistenceService.getModelName(), 2L))).when(teamPersistenceService)
                                                                                                                                                       .findById(2L);
    }
    ...
    void validateOnCreateShouldThrowExceptionWhenIdIsNotNull() {
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnCreate(team1));
    ...
    void validateOnCreateShouldThrowExceptionWhenTeamAlreadyExists() {
        ...
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnCreate(teamWithIdNull));
    ...
    void validateOnCreateShouldThrowExceptionWhenModelIsNameIsNull() {
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnCreate(teamWithoutName));
        ...
        List<ErrorDto> expectedErrors = List.of(new ErrorDto("ATTRIBUTE_NOT_NULL", List.of("name", "Team")), new ErrorDto("ATTRIBUTE_NOT_BLANK", List.of("name", "Team")));
    ...
    void validateOnUpdateShouldThrowExceptionWhenModelIdIsNull() {
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnUpdate(teamWithIdNull.getId(), teamWithIdNull));
    ...
    void validateOnUpdateShouldThrowExceptionWhenModelIsNull() {
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnUpdate(null, null));
        verify(validator, times(1)).throwExceptionWhenModelIsNull(null);
        List<ErrorDto> expectedErrors = List.of(new ErrorDto("MODEL_NULL", List.of("Team")));
    ...
    void validateOnUpdateShouldThrowExceptionWhenModelIsNameIsNull() {
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnUpdate(teamWithoutNameWithId.getId(), teamWithoutNameWithId));
