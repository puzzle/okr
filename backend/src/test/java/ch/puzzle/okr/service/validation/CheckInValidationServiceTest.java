...
class CheckInValidationServiceTest {
    ...
    private final KeyResult keyResultOrdinal = KeyResultOrdinal.Builder
            ...
            .withOwner(user)
            .build();
    private final CheckIn checkInMetric = CheckInMetric.Builder
            .builder()
            .withValue(45D)
            ...
            .withCreatedBy(user)
            .build();
    private final CheckIn checkInOrdinal = CheckInMetric.Builder
            .builder()
            .withValue(27D)
            .withId(1L)
            ...
            .withCreatedBy(user)
            .build();
    private final CheckIn fullCheckIn = CheckInOrdinal.Builder
            .builder()
    ...
    private static Stream<Arguments> confidenceValidationArguments() {
        return Stream
                .of(arguments(-1, List.of(new ErrorDto("ATTRIBUTE_MIN_VALUE", List.of("confidence", "CheckIn", "0")))),
    ...
    void shouldThrowExceptionOnValidateOnCreateWhenConfidenceIsInvalid(Integer confidence,
        ...
        // arrange
        CheckIn checkIn = CheckInMetric.Builder
                .builder() //
                .withValue(40.9) //
                .withChangeInfo("ChangeInfo") //
                .withInitiatives("Initiatives") //
    ...
    void shouldThrowExceptionOnValidateOnCreateWhenAttrsAreMissing() {
        // arrange
        CheckIn checkInInvalid = CheckInMetric.Builder
                .builder() //
                .withId(null) //
                .withChangeInfo("ChangeInfo")
                .build();
    ...
    void shouldThrowExceptionOnValidateOnUpdateWhenCheckInsOfKeyResultIsEmpty() {
        ...
        CheckIn checkIn = CheckInMetric.Builder
                ...
                .withModifiedOn(LocalDateTime.MAX)
                .build();
        CheckIn savedCheckIn = CheckInMetric.Builder
                .builder()
                .withId(id)
                .withChangeInfo("")
                .withInitiatives("Initiatives")
