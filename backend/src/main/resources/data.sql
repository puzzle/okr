...
insert into objective(id, title, owner_id, team_id, quarter_id, description, progress, created_by_id, created_on) values
        (1, 'Objective 1', 1, 1, 1, 'This is the description of Objective 1', '20.0', 1, '2022-01-01'),
        (2, 'Objective 2', 2, 2, 2, 'This is the description of Objective 2', '60.0', 2, '2019-01-01'),
        (3, 'Objective 3', 4, 3, 3, 'This is the description of Objective 3', '80.0', 3, '2020-01-01');
