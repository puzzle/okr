  ...
  () => {
    ...
    [
      ...
      it("Create metric checkin and validate value of scoring component",
        () => {
          setupMetricKR(
            `Metric kr with check-in value ${value}`,
            baseline,
            stretchgoal,
            value
          );
          const percentage = getPercentageMetric(baseline,
            stretchgoal,
            value);
          cy.validateScoring(false,
            percentage);
    ...
    [200,
      ...
      it("show indicator that value is negative",
        () => {
          setupMetricKR(
            `Check indicator with value ${value}`,
            baseline,
            stretchgoal,
            value
          );
      ...
      it("Create ordinal checkin and validate value of scoring component",
        () => {
          overviewPage
            ...
            .withOrdinalValues("My commit zone",
              "My target zone",
              "My stretch goal")
