...
describe("MemberListTableComponent",
  () => {
    ...
    it("should set displayedColumns for all teams correctly",
      fakeAsync(() => {
    ...
    it("should set displayedColumns for admin team correctly",
      fakeAsync(() => {
    ...
    it("removeMemberFromTeam should call removeUserFromTeam and reloadUsers if confirmed",
      fakeAsync(() => {
        const entry = {
          id: 1
        };
        ...
        component.removeMemberFromTeam(entry as UserTableEntry,
        ...
        expect(teamServiceMock.removeUserFromTeam)
          .toBeCalledTimes(1);
        expect(teamServiceMock.removeUserFromTeam)
          .toBeCalledWith(entry.id,
            component.selectedTeam$.value);
    ...
    it("removeMemberFromTeam should not call removeUserFromTeam and reloadUsers if not confirmed",
      fakeAsync(() => {
        const entry = {
          id: 1
        };
    ...
    it("saveUserTeamRole should call updateOrAddTeamMembership and reload users",
      fakeAsync(() => {
        ...
        component.saveUserTeamMembership(true,
          entry,
          ut);
        tick();
