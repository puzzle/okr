...
class ObjectiveControllerIT {
    ...
    static MeasureDto measure1Dto = new MeasureDto(1L, 5L, 10, "foo", "boo", 1L, null, LocalDateTime.of(2022, 8, 12, 1, 1));
    static MeasureDto measure2Dto = new MeasureDto(2L, 7L, 10, "foo", "boo", 1L, null, LocalDateTime.of(2022, 8, 12, 1, 1));
