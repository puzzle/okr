...
describe("ErrorInterceptor",
  () => {
    ...
    ["objective",
      1],
    ["keyresult",
      1]])("handleDrawerError on route %p should be called %p times",
      (url: string, isCalledTimes: number) => {
    ...
    ["NOT_AUTHORIZED_TO_WRITE",
      ["Check-in"]]])("handleErrorToaster should show correct toaster",
      (key: string, params: string[]) => {
        const ERROR_PREFIX = "ERROR.";
        jest.spyOn(translator,
          "instant");
        jest.spyOn(toaster,
          "showError");
        jest.spyOn(String.prototype,
          "format");
        const requestMock = {
          error: {
            errors: [{
    ...
    [
      ...
      (
        ...
        interceptor.handleSuccessToaster(requestMock,
          method);
    ...
    [
      ...
      HttpType.GET,
      "KEYRESULT"
    ]])("handleSuccessToaster should not show toaster ",
    ...
    it.each([
      ...
      (
        ...
        const successMessageKey = interceptor.getSuccessMessageKey(url,
          code,
          method);
    ...
    ["http://localhost:4200/",
      ...
      false]])("checkIfSuccessToasterIsShown should work as intended",
    ...
    it("should return custom success message on objective creation in backlog",
      () => {
        ...
        interceptor.handleSuccessToaster(mockHttpResponse,
          HttpType.POST);
        expect(translator.instant)
