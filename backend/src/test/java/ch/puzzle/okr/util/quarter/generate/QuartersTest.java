...
public class QuartersTest {
    ...
    void currentQuarterShouldThrowExceptionIfNoMatchingQuarterIsFoundForNow() {
        ...
        // act
        RuntimeException exception = assertThrows(RuntimeException.class, () -> allQuartersOfCurrentYear.currentQuarter(in2Years));
    ...
    private static Stream<Arguments> boundaryDatesAndLabels() {
        return Stream.of(Arguments.of(LocalDate.of(2024, 7, 1), "('GJ 24/25-Q1', '2024-07-01', '2024-09-30')"), Arguments.of(LocalDate.of(2024, 9, 30), "('GJ 24/25-Q1', '2024-07-01', '2024-09-30')"));
    }
}
