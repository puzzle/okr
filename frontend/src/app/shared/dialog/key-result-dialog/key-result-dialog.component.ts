...
export class KeyResultDialogComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        if (this.data.keyResult) {
            ...
            this.isMetricKeyResult() ? this.setMetricValuesInForm(this.data.keyResult as KeyResultMetric)
    ...
    saveKeyResult(openNewDialog = false) {
        ...
        let keyResult = this.isMetricKeyResult() ? {...value, objective: this.data.objective} as KeyResultMetricDTO
