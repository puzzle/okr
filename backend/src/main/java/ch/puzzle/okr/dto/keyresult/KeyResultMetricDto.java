...
public record KeyResultMetricDto(Long id, int version, String keyResultType, String title, String description,
        Double baseline, Double commitGoal, Double targetGoal, Double stretchGoal, UnitDto unit, KeyResultUserDto owner,
        KeyResultObjectiveDto objective, KeyResultLastCheckInMetricDto lastCheckIn, LocalDateTime createdOn,
