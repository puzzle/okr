...
public class CheckInPersistenceServiceIT {
    ...
    void tearDown() {
        try {
            if (createdMeasure != null) {
                checkInPersistenceService.findById(createdMeasure.getId());
                checkInPersistenceService.deleteById(createdMeasure.getId());
            }
    ...
    void saveMeasure_ShouldSaveNewMeasure() {
        ...
        createdMeasure = checkInPersistenceService.save(measure);
    ...
    void updateKeyResult_ShouldUpdateKeyResult() {
        ...
        Measure updateMeasure = checkInPersistenceService.save(createdMeasure);
    ...
    void updateKeyResult_ShouldThrowExceptionWhenKeyResultNotFound() {
        ...
        ResponseStatusException exception = assertThrows(ResponseStatusException.class,
                () -> checkInPersistenceService.save(measure));
    ...
    void getAllMeasure_ShouldReturnListOfAllMeasures() {
        List<Measure> measures = checkInPersistenceService.findAll();
    ...
    void getMeasureById_ShouldReturnMeasureProperly() {
        Measure measure = checkInPersistenceService.findById(20L);
    ...
    void getMeasuresByKeyResultIdAndMeasureDate_ShouldReturnMeasuresProperly() {
        List<Measure> measures = checkInPersistenceService.getMeasuresByKeyResultIdAndMeasureDate(8L,
