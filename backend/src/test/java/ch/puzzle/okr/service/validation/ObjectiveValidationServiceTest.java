...
class ObjectiveValidationServiceTest {
    ...
    private static Stream<Arguments> nameValidationArguments() {
        return Stream.of(arguments(StringUtils.repeat('1', 251), List.of(new ErrorDto("ATTRIBUTE_SIZE_BETWEEN", List.of("title", "Objective", "2", "250")))), arguments(StringUtils.repeat('1', 1), List.of(new ErrorDto("ATTRIBUTE_SIZE_BETWEEN", List.of("title", "Objective", "2", "250")))),

                         arguments("", List.of(new ErrorDto("ATTRIBUTE_SIZE_BETWEEN", List.of("title", "Objective", "2", "250")), new ErrorDto("ATTRIBUTE_NOT_BLANK", List.of("title", "Objective")))),

                         arguments(" ", List.of(new ErrorDto("ATTRIBUTE_SIZE_BETWEEN", List.of("title", "Objective", "2", "250")), new ErrorDto("ATTRIBUTE_NOT_BLANK", List.of("title", "Objective")))),

                         arguments("         ", List.of(new ErrorDto("ATTRIBUTE_NOT_BLANK", List.of("title", "Objective")))), arguments(null, List.of(new ErrorDto("ATTRIBUTE_NOT_BLANK", List.of("title", "Objective")), new ErrorDto("ATTRIBUTE_NOT_NULL", List.of("title", "Objective")))));
    }
    ...
    void setUp() {
        ...
        doThrow(new OkrResponseStatusException(HttpStatus.NOT_FOUND, String.format("%s with id %s not found", objectivePersistenceService.getModelName(), 2L))).when(objectivePersistenceService)
                                                                                                                                                               .findById(2L);
    }
    ...
    void validateOnCreateShouldThrowExceptionWhenIdIsNotNull() {
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnCreate(objective1));
    ...
    void validateOnCreateShouldThrowExceptionWhenTitleIsInvalid(String title, List<ErrorDto> expectedErrors) {
        ...
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnCreate(objective));
    ...
    void validateOnCreateShouldThrowExceptionWhenAttrsAreMissing() {
        Objective objectiveInvalid = Objective.Builder.builder()
                                                      ...
                                                      .withQuarter(quarter)
                                                      .build();
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnCreate(objectiveInvalid));

        List<ErrorDto> expectedErrors = List.of(new ErrorDto("ATTRIBUTE_NOT_NULL", List.of("team", "Objective")), new ErrorDto("ATTRIBUTE_NOT_NULL", List.of("createdBy", "Objective")), new ErrorDto("ATTRIBUTE_NOT_NULL", List.of("createdOn", "Objective")), new ErrorDto("ATTRIBUTE_NOT_NULL", List.of("state", "Objective")));
    ...
    void validateOnCreateShouldThrowExceptionWhenAttrModifiedByIsSet() {
        ...
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnCreate(objectiveInvalid));
        List<ErrorDto> expectedErrors = List.of(new ErrorDto("ATTRIBUTE_SET_FORBIDDEN", List.of("ModifiedBy", "User{id=1, version=0, firstname='Bob', lastname='Kaufmann', email='kaufmann@puzzle.ch', isOkrChampion='false'}")));
    ...
    void validateOnUpdateShouldThrowExceptionWhenIdIsNull() {
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnUpdate(null, objectiveMinimal));
    ...
    void validateOnUpdateShouldThrowExceptionWhenIdHasChanged() {
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnUpdate(7L, objective1));
    ...
    void validateOnUpdateShouldThrowExceptionWhenTitleIsInvalid(String title, List<ErrorDto> expectedErrors) {
        ...
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnUpdate(3L, objective));
    ...
    void validateOnUpdateShouldThrowExceptionWhenAttrsAreMissing() {
        ...
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnUpdate(5L, objective));
        List<ErrorDto> expectedErrors = List.of(new ErrorDto("ATTRIBUTE_NOT_NULL", List.of("team", "Objective")), new ErrorDto("ATTRIBUTE_NOT_NULL", List.of("createdBy", "Objective")), new ErrorDto("ATTRIBUTE_NOT_NULL", List.of("createdOn", "Objective")), new ErrorDto("ATTRIBUTE_NOT_NULL", List.of("state", "Objective")));
    ...
    void validateOnUpdateShouldThrowExceptionWhenAttrModifiedByIsNotSet() {
        ...
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnUpdate(1L, objectiveInvalid));
    ...
    void validateOnUpdateShouldThrowExceptionWheTeamHasChanged() {
        ...
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnUpdate(1L, updatedObjective));
    ...
    void validateOnCreateShouldThrowExceptionWhenQuarterIsBacklogAndStateIsNotDraft(State state) {
        ...
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnCreate(invalidObjective));
        List<ErrorDto> expectedErrors = List.of(new ErrorDto("ATTRIBUTE_MUST_BE_DRAFT", List.of("Objective", "Draft", state.toString())));
    ...
    void validateOnUpdateShouldThrowExceptionWhenQuarterIsBacklogAndStateIsNotDraft(State state) {
        ...
        OkrResponseStatusException exception = assertThrows(OkrResponseStatusException.class, () -> validator.validateOnUpdate(1L, invalidObjective));
        List<ErrorDto> expectedErrors = List.of(new ErrorDto("ATTRIBUTE_MUST_BE_DRAFT", List.of("Objective", "Draft", state.toString())));
