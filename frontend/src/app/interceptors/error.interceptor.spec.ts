...
describe('ErrorInterceptor', () => {
  ...
  it.each([
    ...
    [1, 'objective'],
    [1, 'keyresult'],
  ])('should call handleDrawerError %p times when routing to %p', (isCalledTimes: number, url: string) => {
  ...
  ])('should show correct error toaster when calling handleErrorToaster()', (key: string, params: string[]) => {
